...
public class EventParticipantController {
    ...
    public ResponseEntity addEventParticipant(@PathVariable Integer eventId, @RequestBody @Valid EventParticipant eventParticipant) {
        eventParticipantService.addEventParticipant(eventId, eventParticipant);
