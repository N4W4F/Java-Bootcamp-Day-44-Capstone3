...
public class CustomerController {
    ...
    // Services - Start
//    @PostMapping("/request/event/{customerId}/{eventId}")
//    public ResponseEntity requestForEventParticipation(@PathVariable Integer customerId, @PathVariable Integer eventId) {
//        customerService.requestForEventParticipation(customerId, eventId);
//        return ResponseEntity.status(200).body(new ApiResponse("You have applied to participate this event, your request is waiting for approval from administration"));
//    }
